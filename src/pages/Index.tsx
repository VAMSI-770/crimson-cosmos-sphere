...
const Index = () => {
  ...
  return (
    <div className="relative min-h-screen bg-background overflow-x-hidden">
      ...
      {/* Nav */}
      <nav className="fixed top-0 left-0 right-0 z-40 backdrop-blur-md bg-background/60 border-b border-border/30">
        <div className="container mx-auto px-6 lg:px-16 flex items-center justify-between h-14">
          <a href="#hero" className="font-display font-bold text-lg italic gold-text">VB</a>
