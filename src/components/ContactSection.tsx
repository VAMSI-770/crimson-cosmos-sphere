  ...
  return (
    <section id="contact" className="relative py-28">
      <div className="container mx-auto px-6 lg:px-16">
        <ScrollReveal>
          <p className="accent-text text-xs tracking-[0.25em] uppercase mb-3 font-medium">Final Scene</p>
          ...
          <ScrollReveal delay={0.2}>
            <form onSubmit={handleSubmit} className="space-y-4">
              <input
                ...
                className="w-full px-4 py-3 rounded-lg bg-secondary border border-border text-foreground placeholder:text-muted-foreground focus:outline-none focus:border-crimson/40 focus:ring-1 focus:ring-crimson/20 transition-all duration-300 text-sm"
              />
              <input
                type="email"
                placeholder="Email"
              ...
              <textarea
                ...
                className="w-full px-4 py-3 rounded-lg bg-secondary border border-border text-foreground placeholder:text-muted-foreground focus:outline-none focus:border-crimson/40 focus:ring-1 focus:ring-crimson/20 transition-all duration-300 resize-none text-sm"
              />
              <button
                type="submit"
                className="w-full py-3 rounded-lg bg-gradient-to-r from-crimson to-violet font-medium text-primary-foreground text-sm transition-all duration-400 hover:shadow-[0_0_30px_hsla(1,95%,48%,0.3)] hover:scale-[1.02]"
              >
                Send Message
              </button>
            </form>
