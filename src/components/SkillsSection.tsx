              ...
              >
                <div className="flex items-center justify-between mb-4">
                  ...
                  <motion.span 
                    ...
                    animate={{ rotate: expandedIndex === gi ? 180 : 0 }}
                  >
                    ↓
                  </motion.span>
                </div>
                ...
                <div className="flex flex-wrap gap-2">
                  {group.skills.map((skill) => (
                    <motion.span
                      key={skill}
                      className="px-3 py-1.5 text-xs font-medium text-secondary-foreground bg-secondary/60 rounded-full border border-border/60 transition-all duration-300 hover:border-blue-primary/30 hover:text-foreground hover:bg-blue-primary/5 hover:shadow-[0_0_15px_hsla(221,83%,53%,0.08)] cursor-default"
