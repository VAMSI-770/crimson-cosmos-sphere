  ...
  return (
    <section id="skills" className="relative py-32">
      <div className="container mx-auto px-6 lg:px-16">
        <ScrollReveal>
          <p className="text-primary text-sm tracking-[0.3em] uppercase mb-3 font-body">Powers</p>
            ...
            <ScrollReveal key={group.title} delay={gi * 0.1}>
              ...
              <div className="flex flex-wrap gap-3">
                {group.skills.map((skill) => (
                  <span
                    key={skill}
                    className="glass-card px-5 py-2.5 text-sm font-medium text-foreground cursor-default transition-all duration-300 hover:shadow-[0_0_25px_hsla(0,100%,45%,0.25)] hover:scale-105 hover:border-primary/40 animate-pulse-glow"
