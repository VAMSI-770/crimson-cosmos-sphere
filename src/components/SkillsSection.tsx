  ...
  return (
    <section id="skills" className="relative py-28">
      <div className="container mx-auto px-6 lg:px-16">
        <ScrollReveal>
          <p className="accent-text text-xs tracking-[0.25em] uppercase mb-3 font-medium">Scene III</p>
              ...
              <div className="module-card rounded-xl p-6 h-full">
                ...
                <div className="flex flex-wrap gap-2">
                  {group.skills.map((skill) => (
                    <span
                      key={skill}
                      className="px-3.5 py-1.5 text-xs font-medium text-secondary-foreground bg-secondary rounded-md border border-border transition-all duration-300 hover:border-crimson/30 hover:text-foreground cursor-default"
                    >
                      {skill}
                    </span>
                  ))}
